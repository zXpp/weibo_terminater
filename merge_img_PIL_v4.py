...
if __name__ == '__main__':
	...
	IMG_PATH = u"D:\\HW\\张雪\\InfoDepar\\tmgppt\\ppt\\709"#os.path.join(ROOT_PATH, 'img')
	...
	# 合并图片
	imgs = glob.glob(os.path.join(IMG_PATH, '*.png'))#abspath:files
	merge_output = os.path.join(IMG_PATH, 'long.png')#absfile
	#begin_time = time.clock()
